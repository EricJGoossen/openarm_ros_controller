...
bool cartesian_control_msgs__msg__cartesian_trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cartesian_control_msgs.msg._cartesian_trajectory_point.CartesianTrajectoryPoint", full_classname_dest, 79) == 0);
  }
  cartesian_control_msgs__msg__CartesianTrajectoryPoint * ros_message = _ros_message;
  {  // time_from_start
  ...
  {  // jerk
    ...
    if (!geometry_msgs__msg__accel__convert_from_py(field, &ros_message->jerk)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // posture
    ...
    if (!cartesian_control_msgs__msg__cartesian_posture__convert_from_py(field, &ros_message->posture)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * cartesian_control_msgs__msg__cartesian_trajectory_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cartesian_control_msgs.msg._cartesian_trajectory_point");
  ...
  {  // jerk
    PyObject * field = NULL;
    field = geometry_msgs__msg__accel__convert_to_py(&ros_message->jerk);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // posture
    PyObject * field = NULL;
    field = cartesian_control_msgs__msg__cartesian_posture__convert_to_py(&ros_message->posture);
    if (!field) {
      return NULL;
    }
    {
