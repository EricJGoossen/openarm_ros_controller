...
bool cartesian_control_msgs__msg__cartesian_tolerance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cartesian_control_msgs.msg._cartesian_tolerance.CartesianTolerance", full_classname_dest, 66) == 0);
  }
  cartesian_control_msgs__msg__CartesianTolerance * ros_message = _ros_message;
  {  // position_error
  ...
  {  // acceleration_error
    ...
    if (!geometry_msgs__msg__accel__convert_from_py(field, &ros_message->acceleration_error)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * cartesian_control_msgs__msg__cartesian_tolerance__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cartesian_control_msgs.msg._cartesian_tolerance");
  ...
  {  // acceleration_error
    PyObject * field = NULL;
    field = geometry_msgs__msg__accel__convert_to_py(&ros_message->acceleration_error);
    if (!field) {
      return NULL;
    }
    {
