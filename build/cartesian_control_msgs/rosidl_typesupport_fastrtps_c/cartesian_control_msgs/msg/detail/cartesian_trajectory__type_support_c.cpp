...
#include "cartesian_control_msgs/msg/detail/cartesian_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "cartesian_control_msgs/msg/detail/cartesian_trajectory_point__functions.h"  // points
...
using _CartesianTrajectory__ros_msg_type = cartesian_control_msgs__msg__CartesianTrajectory;
  ...
  cartesian_control_msgs__msg__CartesianTrajectory * ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      cartesian_control_msgs__msg__CartesianTrajectoryPoint__Sequence__fini(&ros_message->points);
    }
    if (!cartesian_control_msgs__msg__CartesianTrajectoryPoint__Sequence__init(&ros_message->points, size)) {
      fprintf(stderr, "failed to create array for field 'points'");
      return false;
    }
    auto array_ptr = ros_message->points.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cartesian_control_msgs__msg__CartesianTrajectoryPoint(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cartesian_control_msgs__msg__CartesianTrajectory;
    is_plain =
      (
      offsetof(DataType, controlled_frame) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__msg__CartesianTrajectory * ros_message = static_cast<const cartesian_control_msgs__msg__CartesianTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__msg__CartesianTrajectory(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__msg__CartesianTrajectory * ros_message = static_cast<cartesian_control_msgs__msg__CartesianTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__msg__CartesianTrajectory(cdr, ros_message);
}

static uint32_t _CartesianTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cartesian_control_msgs__msg__CartesianTrajectory(
...
static size_t _CartesianTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cartesian_control_msgs__msg__CartesianTrajectory(
