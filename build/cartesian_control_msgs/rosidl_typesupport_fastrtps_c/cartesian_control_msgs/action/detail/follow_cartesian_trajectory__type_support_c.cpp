...
#include "cartesian_control_msgs/msg/detail/cartesian_tolerance__functions.h"  // goal_tolerance, path_tolerance
#include "cartesian_control_msgs/msg/detail/cartesian_trajectory__functions.h"  // trajectory
...
bool cdr_serialize_cartesian_control_msgs__msg__CartesianTrajectory(
  const cartesian_control_msgs__msg__CartesianTrajectory * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_cartesian_control_msgs__msg__CartesianTrajectory(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__msg__CartesianTrajectory * ros_message);

size_t get_serialized_size_cartesian_control_msgs__msg__CartesianTrajectory(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_cartesian_control_msgs__msg__CartesianTrajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

bool cdr_serialize_key_cartesian_control_msgs__msg__CartesianTrajectory(
  const cartesian_control_msgs__msg__CartesianTrajectory * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_cartesian_control_msgs__msg__CartesianTrajectory(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_cartesian_control_msgs__msg__CartesianTrajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cartesian_control_msgs, msg, CartesianTrajectory)();
...
bool cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_Goal * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: trajectory
  {
    cdr_serialize_cartesian_control_msgs__msg__CartesianTrajectory(
      &ros_message->trajectory, cdr);
  }

  // Field name: path_tolerance
  {
    cdr_serialize_cartesian_control_msgs__msg__CartesianTolerance(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__action__FollowCartesianTrajectory_Goal * ros_message)
{
  // Field name: trajectory
  {
    cdr_deserialize_cartesian_control_msgs__msg__CartesianTrajectory(cdr, &ros_message->trajectory);
  }

  // Field name: path_tolerance
  {
    cdr_deserialize_cartesian_control_msgs__msg__CartesianTolerance(cdr, &ros_message->path_tolerance);
  }

  // Field name: goal_tolerance
  {
    cdr_deserialize_cartesian_control_msgs__msg__CartesianTolerance(cdr, &ros_message->goal_tolerance);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: trajectory
  current_alignment += get_serialized_size_cartesian_control_msgs__msg__CartesianTrajectory(
    &(ros_message->trajectory), current_alignment);

  // Field name: path_tolerance
  current_alignment += get_serialized_size_cartesian_control_msgs__msg__CartesianTolerance(
  ...
  size_t current_alignment)
{
  ...
  // Field name: trajectory
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cartesian_control_msgs__msg__CartesianTrajectory(
  ...
  // Field name: path_tolerance
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cartesian_control_msgs__msg__CartesianTolerance(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_Goal * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: trajectory
  {
    cdr_serialize_key_cartesian_control_msgs__msg__CartesianTrajectory(
      &ros_message->trajectory, cdr);
  }

  // Field name: path_tolerance
  {
    cdr_serialize_key_cartesian_control_msgs__msg__CartesianTolerance(
      &ros_message->path_tolerance, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_Goal__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_Goal__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: trajectory
  current_alignment += get_serialized_size_key_cartesian_control_msgs__msg__CartesianTrajectory(
    &(ros_message->trajectory), current_alignment);

  // Field name: path_tolerance
  current_alignment += get_serialized_size_key_cartesian_control_msgs__msg__CartesianTolerance(
    &(ros_message->path_tolerance), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: trajectory
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartesian_control_msgs__msg__CartesianTrajectory(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: path_tolerance
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartesian_control_msgs__msg__CartesianTolerance(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__action__FollowCartesianTrajectory_Goal * ros_message = static_cast<const cartesian_control_msgs__action__FollowCartesianTrajectory_Goal *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__action__FollowCartesianTrajectory_Goal * ros_message = static_cast<cartesian_control_msgs__action__FollowCartesianTrajectory_Goal *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_Result * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__action__FollowCartesianTrajectory_Result * ros_message)
{
  // Field name: error_code
  {
    cdr >> ros_message->error_code;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_Result * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: error_code
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_Result__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_Result__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__action__FollowCartesianTrajectory_Result * ros_message = static_cast<const cartesian_control_msgs__action__FollowCartesianTrajectory_Result *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__action__FollowCartesianTrajectory_Result * ros_message = static_cast<cartesian_control_msgs__action__FollowCartesianTrajectory_Result *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(cdr, ros_message);
}
...
#include "cartesian_control_msgs/msg/detail/cartesian_trajectory_point__functions.h"  // actual, desired, error
// already included above
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: desired
  {
    cdr_serialize_cartesian_control_msgs__msg__CartesianTrajectoryPoint(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: desired
  {
    cdr_deserialize_cartesian_control_msgs__msg__CartesianTrajectoryPoint(cdr, &ros_message->desired);
  }

  // Field name: actual
  {
    cdr_deserialize_cartesian_control_msgs__msg__CartesianTrajectoryPoint(cdr, &ros_message->actual);
  }

  // Field name: error
  {
    cdr_deserialize_cartesian_control_msgs__msg__CartesianTrajectoryPoint(cdr, &ros_message->error);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: desired
  current_alignment += get_serialized_size_cartesian_control_msgs__msg__CartesianTrajectoryPoint(
  ...
  size_t current_alignment)
{
  ...
  // Field name: desired
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cartesian_control_msgs__msg__CartesianTrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: desired
  {
    cdr_serialize_key_cartesian_control_msgs__msg__CartesianTrajectoryPoint(
      &ros_message->desired, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_Feedback__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_Feedback__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: desired
  current_alignment += get_serialized_size_key_cartesian_control_msgs__msg__CartesianTrajectoryPoint(
    &(ros_message->desired), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: desired
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartesian_control_msgs__msg__CartesianTrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback * ros_message = static_cast<const cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback * ros_message = static_cast<cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: goal_id
  {
  ...
  // Field name: goal
  {
    cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request * ros_message)
{
  // Field name: goal_id
  {
  ...
  // Field name: goal
  {
    cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(cdr, &ros_message->goal);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: goal_id
  ...
  // Field name: goal
  {
    cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(
      &ros_message->goal, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: goal
  current_alignment += get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(
    &(ros_message->goal), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request * ros_message = static_cast<const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request * ros_message = static_cast<cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: accepted
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response * ros_message)
{
  // Field name: accepted
  {
    uint8_t tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: accepted
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response * ros_message = static_cast<const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response * ros_message = static_cast<cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(cdr, ros_message);
}
...
using _FollowCartesianTrajectory_SendGoal_Event__ros_msg_type = cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request__Sequence__fini(&ros_message->request);
    }
    if (!cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response__Sequence__fini(&ros_message->response);
    }
    if (!cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_SendGoal_Event__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_SendGoal_Event__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event * ros_message = static_cast<const cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event * ros_message = static_cast<cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(cdr, ros_message);
}

static uint32_t _FollowCartesianTrajectory_SendGoal_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(
      untyped_ros_message, 0));
}
...
static size_t _FollowCartesianTrajectory_SendGoal_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_FollowCartesianTrajectory_SendGoal_Event = {
  "cartesian_control_msgs::action",
...
static rosidl_message_type_support_t _FollowCartesianTrajectory_SendGoal_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FollowCartesianTrajectory_SendGoal_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cartesian_control_msgs, action, FollowCartesianTrajectory_SendGoal_Event)() {
  return &_FollowCartesianTrajectory_SendGoal_Event__type_support;
}
...
static rosidl_service_type_support_t FollowCartesianTrajectory_SendGoal__handle = {
  ...
  &_FollowCartesianTrajectory_SendGoal_Request__type_support,
  &_FollowCartesianTrajectory_SendGoal_Response__type_support,
  &_FollowCartesianTrajectory_SendGoal_Event__type_support,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: goal_id
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request * ros_message)
{
  // Field name: goal_id
  {
    cdr_deserialize_unique_identifier_msgs__msg__UUID(cdr, &ros_message->goal_id);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: goal_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_GetResult_Request__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request * ros_message = static_cast<const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request * ros_message = static_cast<cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: status
  {
  ...
  // Field name: result
  {
    cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response * ros_message)
{
  // Field name: status
  {
    cdr >> ros_message->status;
  ...
  // Field name: result
  {
    cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(cdr, &ros_message->result);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: status
  ...
  // Field name: result
  {
    cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(
      &ros_message->result, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_GetResult_Response__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: result
  current_alignment += get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(
    &(ros_message->result), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response * ros_message = static_cast<const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response * ros_message = static_cast<cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(cdr, ros_message);
}
...
using _FollowCartesianTrajectory_GetResult_Event__ros_msg_type = cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event * ros_message)
{
  // Field name: info
  {
    cdr_deserialize_service_msgs__msg__ServiceEventInfo(cdr, &ros_message->info);
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request__Sequence__fini(&ros_message->request);
    }
    if (!cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response__Sequence__fini(&ros_message->response);
    }
    if (!cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_GetResult_Event__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_GetResult_Event__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event * ros_message = static_cast<const cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event * ros_message = static_cast<cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(cdr, ros_message);
}

static uint32_t _FollowCartesianTrajectory_GetResult_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(
      untyped_ros_message, 0));
}
...
static size_t _FollowCartesianTrajectory_GetResult_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_FollowCartesianTrajectory_GetResult_Event = {
  "cartesian_control_msgs::action",
...
static rosidl_message_type_support_t _FollowCartesianTrajectory_GetResult_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FollowCartesianTrajectory_GetResult_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cartesian_control_msgs, action, FollowCartesianTrajectory_GetResult_Event)() {
  return &_FollowCartesianTrajectory_GetResult_Event__type_support;
}
...
static rosidl_service_type_support_t FollowCartesianTrajectory_GetResult__handle = {
  ...
  get_service_typesupport_handle_function,
  &_FollowCartesianTrajectory_GetResult_Request__type_support,
  &_FollowCartesianTrajectory_GetResult_Response__type_support,
  &_FollowCartesianTrajectory_GetResult_Event__type_support,
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_CREATE_EVENT_MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_c,
    cartesian_control_msgs,
    action,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: goal_id
  {
  ...
  // Field name: feedback
  {
    cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage * ros_message)
{
  // Field name: goal_id
  {
    cdr_deserialize_unique_identifier_msgs__msg__UUID(cdr, &ros_message->goal_id);
  ...
  // Field name: feedback
  {
    cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(cdr, &ros_message->feedback);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
bool cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage(
  const cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: goal_id
  ...
  // Field name: feedback
  {
    cdr_serialize_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(
      &ros_message->feedback, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FollowCartesianTrajectory_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _FollowCartesianTrajectory_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: feedback
  current_alignment += get_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(
    &(ros_message->feedback), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cartesian_control_msgs
size_t max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cartesian_control_msgs__action__FollowCartesianTrajectory_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage * ros_message = static_cast<const cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage * ros_message = static_cast<cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cartesian_control_msgs__action__FollowCartesianTrajectory_FeedbackMessage(cdr, ros_message);
}
