...
class Metaclass_CartesianTrajectoryPoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cartesian_control_msgs.msg import CartesianPosture
            if CartesianPosture.__class__._TYPE_SUPPORT is None:
                CartesianPosture.__class__.__import_type_support__()
...
class CartesianTrajectoryPoint(metaclass=Metaclass_CartesianTrajectoryPoint):
    ...
    _fields_and_field_types = {
        ...
        'jerk': 'geometry_msgs/Accel',
        'posture': 'cartesian_control_msgs/CartesianPosture',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['geometry_msgs', 'msg'], 'Accel'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'msg'], 'CartesianPosture'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Accel
        self.jerk = kwargs.get('jerk', Accel())
        from cartesian_control_msgs.msg import CartesianPosture
        self.posture = kwargs.get('posture', CartesianPosture())
    ...
    def jerk(self, value):
        if self._check_fields:
            ...
            assert \
                isinstance(value, Accel), \
                "The 'jerk' field must be a sub message of type 'Accel'"
        self._jerk = value
    ...
    def posture(self, value):
        if self._check_fields:
            from cartesian_control_msgs.msg import CartesianPosture
            assert \
                isinstance(value, CartesianPosture), \
                "The 'posture' field must be a sub message of type 'CartesianPosture'"
        self._posture = value
