...
class CartesianTolerance(metaclass=Metaclass_CartesianTolerance):
    ...
    _fields_and_field_types = {
        ...
        'acceleration_error': 'geometry_msgs/Accel',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Accel
        self.acceleration_error = kwargs.get('acceleration_error', Accel())
    ...
    def acceleration_error(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'acceleration_error' field must be a sub message of type 'Accel'"
