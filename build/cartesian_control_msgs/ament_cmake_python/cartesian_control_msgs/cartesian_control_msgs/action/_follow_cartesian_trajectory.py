...
class Metaclass_FollowCartesianTrajectory_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('cartesian_control_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'cartesian_control_msgs.action.FollowCartesianTrajectory_Goal')
            logger.debug(
            ...
            from cartesian_control_msgs.msg import CartesianTolerance
...
class FollowCartesianTrajectory_Goal(metaclass=Metaclass_FollowCartesianTrajectory_Goal):
    ...
    _fields_and_field_types = {
        'trajectory': 'cartesian_control_msgs/CartesianTrajectory',
        'path_tolerance': 'cartesian_control_msgs/CartesianTolerance',
        'goal_tolerance': 'cartesian_control_msgs/CartesianTolerance',
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'msg'], 'CartesianTrajectory'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'msg'], 'CartesianTolerance'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'msg'], 'CartesianTolerance'),  # noqa: E501
...
class Metaclass_FollowCartesianTrajectory_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cartesian_control_msgs.action.FollowCartesianTrajectory_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'INVALID_POSTURE': cls.__constants['INVALID_POSTURE'],
        }

    @property
    def SUCCESSFUL(self):
        """Message constant 'SUCCESSFUL'."""
        return Metaclass_FollowCartesianTrajectory_Result.__constants['SUCCESSFUL']

    @property
    def INVALID_GOAL(self):
        """Message constant 'INVALID_GOAL'."""
        return Metaclass_FollowCartesianTrajectory_Result.__constants['INVALID_GOAL']

    @property
    def INVALID_JOINTS(self):
        """Message constant 'INVALID_JOINTS'."""
        return Metaclass_FollowCartesianTrajectory_Result.__constants['INVALID_JOINTS']

    @property
    def OLD_HEADER_TIMESTAMP(self):
        """Message constant 'OLD_HEADER_TIMESTAMP'."""
        return Metaclass_FollowCartesianTrajectory_Result.__constants['OLD_HEADER_TIMESTAMP']

    @property
    def PATH_TOLERANCE_VIOLATED(self):
        """Message constant 'PATH_TOLERANCE_VIOLATED'."""
        return Metaclass_FollowCartesianTrajectory_Result.__constants['PATH_TOLERANCE_VIOLATED']

    @property
    def GOAL_TOLERANCE_VIOLATED(self):
        """Message constant 'GOAL_TOLERANCE_VIOLATED'."""
        return Metaclass_FollowCartesianTrajectory_Result.__constants['GOAL_TOLERANCE_VIOLATED']

    @property
    def INVALID_POSTURE(self):
        """Message constant 'INVALID_POSTURE'."""
        return Metaclass_FollowCartesianTrajectory_Result.__constants['INVALID_POSTURE']
...
class Metaclass_FollowCartesianTrajectory_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cartesian_control_msgs.action.FollowCartesianTrajectory_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowCartesianTrajectory_Feedback(metaclass=Metaclass_FollowCartesianTrajectory_Feedback):
    ...
    _fields_and_field_types = {
        ...
        'controlled_frame': 'string',
        'desired': 'cartesian_control_msgs/CartesianTrajectoryPoint',
        'actual': 'cartesian_control_msgs/CartesianTrajectoryPoint',
        'error': 'cartesian_control_msgs/CartesianTrajectoryPoint',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'msg'], 'CartesianTrajectoryPoint'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'msg'], 'CartesianTrajectoryPoint'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'msg'], 'CartesianTrajectoryPoint'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.controlled_frame = kwargs.get('controlled_frame', str())
        from cartesian_control_msgs.msg import CartesianTrajectoryPoint
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.controlled_frame != other.controlled_frame:
            return False
    ...
    @builtins.property
    def controlled_frame(self):
        """Message field 'controlled_frame'."""
        return self._controlled_frame

    @controlled_frame.setter
    def controlled_frame(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'controlled_frame' field must be of type 'str'"
        self._controlled_frame = value
...
class FollowCartesianTrajectory_SendGoal_Request(metaclass=Metaclass_FollowCartesianTrajectory_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'cartesian_control_msgs/FollowCartesianTrajectory_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'action'], 'FollowCartesianTrajectory_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Goal
...
class Metaclass_FollowCartesianTrajectory_SendGoal_Event(type):
    """Metaclass of message 'FollowCartesianTrajectory_SendGoal_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__follow_cartesian_trajectory__send_goal__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__follow_cartesian_trajectory__send_goal__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__follow_cartesian_trajectory__send_goal__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__follow_cartesian_trajectory__send_goal__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__follow_cartesian_trajectory__send_goal__event
...
class FollowCartesianTrajectory_SendGoal_Event(metaclass=Metaclass_FollowCartesianTrajectory_SendGoal_Event):
    """Message class 'FollowCartesianTrajectory_SendGoal_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<cartesian_control_msgs/FollowCartesianTrajectory_SendGoal_Request, 1>',
        'response': 'sequence<cartesian_control_msgs/FollowCartesianTrajectory_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'action'], 'FollowCartesianTrajectory_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'action'], 'FollowCartesianTrajectory_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from cartesian_control_msgs.action import FollowCartesianTrajectory_SendGoal_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, FollowCartesianTrajectory_SendGoal_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'FollowCartesianTrajectory_SendGoal_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from cartesian_control_msgs.action import FollowCartesianTrajectory_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, FollowCartesianTrajectory_SendGoal_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'FollowCartesianTrajectory_SendGoal_Response'"
...
class Metaclass_FollowCartesianTrajectory_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cartesian_control_msgs.action.FollowCartesianTrajectory_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from cartesian_control_msgs.action import _follow_cartesian_trajectory
            ...
            if _follow_cartesian_trajectory.Metaclass_FollowCartesianTrajectory_SendGoal_Event._TYPE_SUPPORT is None:
                _follow_cartesian_trajectory.Metaclass_FollowCartesianTrajectory_SendGoal_Event.__import_type_support__()


class FollowCartesianTrajectory_SendGoal(metaclass=Metaclass_FollowCartesianTrajectory_SendGoal):
    from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_SendGoal_Request as Request
    from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_SendGoal_Response as Response
    from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_SendGoal_Event as Event
...
class FollowCartesianTrajectory_GetResult_Response(metaclass=Metaclass_FollowCartesianTrajectory_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'cartesian_control_msgs/FollowCartesianTrajectory_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'action'], 'FollowCartesianTrajectory_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Result
...
class Metaclass_FollowCartesianTrajectory_GetResult_Event(type):
    """Metaclass of message 'FollowCartesianTrajectory_GetResult_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__follow_cartesian_trajectory__get_result__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__follow_cartesian_trajectory__get_result__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__follow_cartesian_trajectory__get_result__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__follow_cartesian_trajectory__get_result__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__follow_cartesian_trajectory__get_result__event
...
class FollowCartesianTrajectory_GetResult_Event(metaclass=Metaclass_FollowCartesianTrajectory_GetResult_Event):
    """Message class 'FollowCartesianTrajectory_GetResult_Event'."""
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<cartesian_control_msgs/FollowCartesianTrajectory_GetResult_Request, 1>',
        'response': 'sequence<cartesian_control_msgs/FollowCartesianTrajectory_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'action'], 'FollowCartesianTrajectory_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'action'], 'FollowCartesianTrajectory_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from cartesian_control_msgs.action import FollowCartesianTrajectory_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, FollowCartesianTrajectory_GetResult_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'FollowCartesianTrajectory_GetResult_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from cartesian_control_msgs.action import FollowCartesianTrajectory_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, FollowCartesianTrajectory_GetResult_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'FollowCartesianTrajectory_GetResult_Response'"
        self._response = value
...
class Metaclass_FollowCartesianTrajectory_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cartesian_control_msgs.action.FollowCartesianTrajectory_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            if _follow_cartesian_trajectory.Metaclass_FollowCartesianTrajectory_GetResult_Event._TYPE_SUPPORT is None:
                _follow_cartesian_trajectory.Metaclass_FollowCartesianTrajectory_GetResult_Event.__import_type_support__()


class FollowCartesianTrajectory_GetResult(metaclass=Metaclass_FollowCartesianTrajectory_GetResult):
    from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_GetResult_Request as Request
    from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_GetResult_Response as Response
    from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_GetResult_Event as Event
...
class Metaclass_FollowCartesianTrajectory_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cartesian_control_msgs.action.FollowCartesianTrajectory_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowCartesianTrajectory_FeedbackMessage(metaclass=Metaclass_FollowCartesianTrajectory_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'cartesian_control_msgs/FollowCartesianTrajectory_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cartesian_control_msgs', 'action'], 'FollowCartesianTrajectory_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Feedback
...
class FollowCartesianTrajectory(metaclass=Metaclass_FollowCartesianTrajectory):
    ...
    from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Goal as Goal
    # The result message defined in the action definition.
    from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Result as Result
    # The feedback message defined in the action definition.
    from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from cartesian_control_msgs.action._follow_cartesian_trajectory import FollowCartesianTrajectory_FeedbackMessage as FeedbackMessage
