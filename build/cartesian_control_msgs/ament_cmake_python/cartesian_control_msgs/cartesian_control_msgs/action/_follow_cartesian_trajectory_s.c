...
bool cartesian_control_msgs__msg__cartesian_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * cartesian_control_msgs__msg__cartesian_trajectory__convert_to_py(void * raw_ros_message);
bool cartesian_control_msgs__msg__cartesian_tolerance__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool cartesian_control_msgs__action__follow_cartesian_trajectory__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // trajectory
    ...
    if (!cartesian_control_msgs__msg__cartesian_trajectory__convert_from_py(field, &ros_message->trajectory)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // path_tolerance
    ...
    if (!cartesian_control_msgs__msg__cartesian_tolerance__convert_from_py(field, &ros_message->path_tolerance)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // goal_tolerance
    ...
    if (!cartesian_control_msgs__msg__cartesian_tolerance__convert_from_py(field, &ros_message->goal_tolerance)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * cartesian_control_msgs__action__follow_cartesian_trajectory__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {  // trajectory
    PyObject * field = NULL;
    field = cartesian_control_msgs__msg__cartesian_trajectory__convert_to_py(&ros_message->trajectory);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // path_tolerance
    PyObject * field = NULL;
    field = cartesian_control_msgs__msg__cartesian_tolerance__convert_to_py(&ros_message->path_tolerance);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // goal_tolerance
    PyObject * field = NULL;
    field = cartesian_control_msgs__msg__cartesian_tolerance__convert_to_py(&ros_message->goal_tolerance);
    if (!field) {
      return NULL;
    }
    {
...
bool cartesian_control_msgs__msg__cartesian_trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool cartesian_control_msgs__action__follow_cartesian_trajectory__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // desired
    ...
    if (!cartesian_control_msgs__msg__cartesian_trajectory_point__convert_from_py(field, &ros_message->desired)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // actual
    ...
    if (!cartesian_control_msgs__msg__cartesian_trajectory_point__convert_from_py(field, &ros_message->actual)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // error
    ...
    if (!cartesian_control_msgs__msg__cartesian_trajectory_point__convert_from_py(field, &ros_message->error)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * cartesian_control_msgs__action__follow_cartesian_trajectory__feedback__convert_to_py(void * raw_ros_message)
{
  ...
  {  // desired
    PyObject * field = NULL;
    field = cartesian_control_msgs__msg__cartesian_trajectory_point__convert_to_py(&ros_message->desired);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // actual
    PyObject * field = NULL;
    field = cartesian_control_msgs__msg__cartesian_trajectory_point__convert_to_py(&ros_message->actual);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // error
    PyObject * field = NULL;
    field = cartesian_control_msgs__msg__cartesian_trajectory_point__convert_to_py(&ros_message->error);
    if (!field) {
      return NULL;
    }
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool cartesian_control_msgs__action__follow_cartesian_trajectory__send_goal__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cartesian_control_msgs.action._follow_cartesian_trajectory.FollowCartesianTrajectory_SendGoal_Event", full_classname_dest, 99) == 0);
  }
  cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!cartesian_control_msgs__action__follow_cartesian_trajectory__send_goal__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    cartesian_control_msgs__action__FollowCartesianTrajectory_SendGoal_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!cartesian_control_msgs__action__follow_cartesian_trajectory__send_goal__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of FollowCartesianTrajectory_SendGoal_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cartesian_control_msgs.action._follow_cartesian_trajectory");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FollowCartesianTrajectory_SendGoal_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = cartesian_control_msgs__action__follow_cartesian_trajectory__send_goal__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = cartesian_control_msgs__action__follow_cartesian_trajectory__send_goal__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool cartesian_control_msgs__action__follow_cartesian_trajectory__get_result__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cartesian_control_msgs.action._follow_cartesian_trajectory.FollowCartesianTrajectory_GetResult_Event", full_classname_dest, 100) == 0);
  }
  cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Event * ros_message = _ros_message;
  {  // info
    PyObject * field = PyObject_GetAttrString(_pymsg, "info");
    if (!field) {
      return false;
  ...
  {  // request
    ...
    if (!cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!cartesian_control_msgs__action__follow_cartesian_trajectory__get_result__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    cartesian_control_msgs__action__FollowCartesianTrajectory_GetResult_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!cartesian_control_msgs__action__follow_cartesian_trajectory__get_result__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of FollowCartesianTrajectory_GetResult_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cartesian_control_msgs.action._follow_cartesian_trajectory");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FollowCartesianTrajectory_GetResult_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->request.data[i]);
      PyObject * pyitem = cartesian_control_msgs__action__follow_cartesian_trajectory__get_result__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->response.data[i]);
      PyObject * pyitem = cartesian_control_msgs__action__follow_cartesian_trajectory__get_result__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
