...
static char cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__time_from_start[] = "time_from_start";
static char cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__pose[] = "pose";
static char cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__twist[] = "twist";
static char cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__acceleration[] = "acceleration";
static char cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__jerk[] = "jerk";
static char cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__posture[] = "posture";

static rosidl_runtime_c__type_description__Field cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELDS[] = {
  {
    {cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__time_from_start, 15, 15},
    {
  ...
  {
    {cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__acceleration, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__jerk, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELD_NAME__posture, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription cartesian_control_msgs__msg__CartesianTrajectoryPoint__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Duration__TYPE_NAME, 31, 31},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {cartesian_control_msgs__msg__CartesianTrajectoryPoint__FIELDS, 6, 6},
    },
    {cartesian_control_msgs__msg__CartesianTrajectoryPoint__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = cartesian_control_msgs__msg__CartesianPosture__get_type_description(NULL)->type_description.fields;
...
cartesian_control_msgs__msg__CartesianTrajectoryPoint__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *cartesian_control_msgs__msg__CartesianTrajectoryPoint__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Duration__get_individual_type_description_source(NULL);
    sources[2] = *cartesian_control_msgs__msg__CartesianPosture__get_individual_type_description_source(NULL);
