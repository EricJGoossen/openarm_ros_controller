...
#include "cartesian_control_msgs/msg/detail/cartesian_tolerance__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cartesian_control_msgs::msg::CartesianTolerance & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.acceleration_error,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs::msg::CartesianTolerance & ros_message)
{
  // Member: position_error
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cartesian_control_msgs::msg::CartesianTolerance;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cartesian_control_msgs::msg::CartesianTolerance *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cartesian_control_msgs::msg::CartesianTolerance *>(
    untyped_ros_message);
...
static size_t _CartesianTolerance__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CartesianTolerance(full_bounded, is_plain, 0);
...
{
  return &cartesian_control_msgs::msg::typesupport_fastrtps_cpp::_CartesianTolerance__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cartesian_control_msgs, msg, CartesianTolerance)() {
  return &cartesian_control_msgs::msg::typesupport_fastrtps_cpp::_CartesianTolerance__handle;
}
