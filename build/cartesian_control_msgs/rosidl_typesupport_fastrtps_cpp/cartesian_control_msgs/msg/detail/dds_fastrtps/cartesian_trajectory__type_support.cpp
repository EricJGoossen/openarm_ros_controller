...
#include "cartesian_control_msgs/msg/detail/cartesian_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cartesian_control_msgs::msg::CartesianTrajectory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cartesian_control_msgs::msg::CartesianTrajectory & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cartesian_control_msgs::msg::CartesianTrajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cartesian_control_msgs::msg::CartesianTrajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cartesian_control_msgs::msg::CartesianTrajectory *>(
    untyped_ros_message);
...
{
  return &cartesian_control_msgs::msg::typesupport_fastrtps_cpp::_CartesianTrajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cartesian_control_msgs, msg, CartesianTrajectory)() {
  return &cartesian_control_msgs::msg::typesupport_fastrtps_cpp::_CartesianTrajectory__handle;
}
