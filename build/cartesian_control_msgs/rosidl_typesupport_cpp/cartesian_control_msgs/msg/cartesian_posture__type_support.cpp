...
static const _CartesianPosture_type_support_symbol_names_t _CartesianPosture_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cartesian_control_msgs, msg, CartesianPosture)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cartesian_control_msgs, msg, CartesianPosture)),
  }
};
...
{
  return &::cartesian_control_msgs::msg::rosidl_typesupport_cpp::CartesianPosture_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cartesian_control_msgs, msg, CartesianPosture)() {
  return get_message_type_support_handle<cartesian_control_msgs::msg::CartesianPosture>();
}
